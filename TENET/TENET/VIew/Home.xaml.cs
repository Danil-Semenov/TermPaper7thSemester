    ...
    public partial class Home : ReactiveWindow<HomeViewModel>
    {
        public Home()
        {
            ...
            this.WhenActivated(disposable =>
            {
                ...
                this.Bind(this.ViewModel, x => x.Button1Text, x => x.Button1.Content);
...
visibility => visibility == Visibility.Visible);
                ...
                this.Bind(this.ViewModel, x => x.Button2Text, x => x.Button2.Content);
...
visibility => visibility == Visibility.Visible);
                ...
                this.Bind(this.ViewModel, x => x.Button3Text, x => x.Button3.Content);
...
visibility => visibility == Visibility.Visible);
                ...
                this.Bind(this.ViewModel, x => x.Button4Text, x => x.Button4.Content);
...
visibility => visibility == Visibility.Visible);
                ...
                this.Bind(this.ViewModel, x => x.Button5Text, x => x.Button5.Content);
